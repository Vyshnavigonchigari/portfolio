  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-1/2 text-center md:text-left mt-0 md:mt-10 mb-20 md:mb-0">
        <h1 className="text-[28px]  lg:text-4xl font-bold mb-1 md:mb-3 text-white ">
          Hey I'm{" "}
        ...
        <h2 className="text-[22px] lg:text-3xl font-semibold mb-1 md:mb-2 flex justify-center md:justify-start items-center gap-2">
          <span className="text-white">I'm a</span>
          <span className=" text-xl lg:text-3xl bg-linear-to-r from-pink-500 via-orange-400 to-purple-400 text-transparent bg-clip-text drop-shadow-lg inline-flex">
            <Typewriter
              options={{
        ...
        <div className="flex justify-center md:justify-start gap-4  mt-3 md:mt-6">
          {[
            {
              icon: <FaGithub />,
              link: "https://github.com/Vyshnavigonchigari",
            },
            {
              icon: <FaLinkedinIn />,
            ...
            <a
              ...
              className="w-10 h-10 flex items-center justify-center rounded-full border-0 text-white text-2xl hover:scale-110 hover:bg-linear-to-r hover:from-cyan-500 hover:via-purple-500 hover:to-pink-500 transition-all duration-300"
            >
              {icon}
            </a>
          ))}
